...
fun BestSellerOfferSection(
    ...
    val bestSellerResult by viewModel.bestSellProduct.collectAsState()
    ...
    when (bestSellerResult) {
        ...
        is NetworkResult.Error -> {
            loading = false
            Log.e("1212", "Best Seller Offer Section has a issue: ${bestSellerResult.message}")
        }
    ...
    )
    {
        ...
        Text(
            text = stringResource(id = com.example.digikala.R.string.best_selling_products),
